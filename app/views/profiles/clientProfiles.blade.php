...
@section('content')
	...
	<div class = 'panels'>
		<div class="panel panel-primary">
			<div class="panel-heading"><h3 class = "panel-title">{{$clientsite->siteName}}</h3></div>
		    <div class="panel-body">{{$clientsite->description}}</div>
		       <div class="panel-body">   <a href="{{ action('ClientSiteController@edit',$clientsite->clientID) }}"
	...
	{{Form::open(array('action' => 'ClientFeatureController@clientFeatureEdit','class'=>'profileForm'))}}<!--pointing to controller -->			
		<div class="panel panel-info">
			<div class="panel-heading"><h4>{{$featureGroup->groupName}}</h4></div>			
				...
				{{ Form::hidden('siteName', $clientsite->siteName)}}							
